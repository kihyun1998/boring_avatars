...
Thirty-five entries as of #64. The ones that have caught something more than
once:

| Rule | Caught in |
|---|---|
| A validity condition came due, and only the condition could tell | #63 |
| A ticket's own acceptance criteria put a valid value in the invalid cell | #62, #64 (a whole notation family) |
